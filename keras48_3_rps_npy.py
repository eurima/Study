...
xy = tr_datagen.flow_from_directory(
    ...
    target_size=(150,150),
    batch_size=200, # 일단 크게 잡는다
    class_mode='categorical',
)
# print(xy[0][0])
# print(xy[0][1])

x = np.save('D:\\Study\\_save_npy\\rps_x', arr=xy[0][0])
y = np.save('D:\\Study\\_save_npy\\rps_y', arr=xy[0][1])

print("完! numpy save complete~!")
# #2.데이터 불러오기
#
x = np.load('D:\\Study\\_save_npy\\rps_x.npy')
y = np.load('D:\\Study\\_save_npy\\rps_y.npy')
...
model = Sequential()
model.add(Conv2D(256,(2,2),activation = 'relu', input_shape =(150,150,3)))
...
'''
loss :  0.006738688331097364
val_loss :  0.6322193145751953
acc :  1.0
val_acc :  0.8125

loss :  0.0004141110402997583
val_loss :  13.132181167602539
acc :  1.0
val_acc :  0.34375
