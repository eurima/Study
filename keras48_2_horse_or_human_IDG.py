...
hiss = model.fit(x_train,y_train, epochs=1000,validation_freq=1,validation_split=0.2,
                    callbacks=[es, mcp])
# hiss = model.fit_generator(x_train,y_train, epochs=1000,validation_freq=1,
#                     callbacks=[es, mcp]
#                     ) 
